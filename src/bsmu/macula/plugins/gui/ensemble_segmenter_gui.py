"""Плагин GUI: пункт меню «Ensemble Segmentation» для ансамблевой сегментации."""
...
#: Имя слоя, в который пишется результат сегментации.
...
class EnsembleSegmenterGuiPlugin(Plugin):
    ...
    def __init__(
        ...
        self._ensemble_segmenter_gui: EnsembleMdiSegmenter | None = None
        self._main_window: MainWindow | None = None

    @property
    def ensemble_segmenter_gui(self) -> EnsembleMdiSegmenter | None:
    ...
    def _enable_gui(self) -> None:
        ...
        # Загрузка маски фовеа — отдельный плагин FoveaMaskLoaderPlugin.
